...
def draw_time_label(draw, time_text: str, label: str, y: int, font):
...
def create_zman_image(
    ...
    draw_time_label(draw, shacharit, "שחרית", 580, big_font)
    draw_time_label(draw, mincha, "מנחה", 830, big_font)
    draw_time_label(draw, arvit, "ערבית", 1080, big_font)
