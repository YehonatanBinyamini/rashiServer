...
def main():
    parser = argparse.ArgumentParser(description="Generate zmanim image and send by email")
    parser.add_argument("--date", help="FRIDAY date (YYYY-MM-DD) to compute week after", default=None)
    ...
    with app.app_context():
        ...
        to_addr = args.to or os.getenv("EMAIL_TO") or os.getenv("EMAIL_USER") or "yonile2106@gmail.com"
